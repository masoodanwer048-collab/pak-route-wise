    ...
    return (
        <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-6 animate-slide-up">
            <div className="flex flex-col gap-2">
                <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100">Container Tracking</h1>
                <p className="text-muted-foreground">Real-time visibility of maritime cargo shipments.</p>
            </div>
